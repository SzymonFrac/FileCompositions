...
using FileCompositions.Extensions.Host.Schema.Register.Builder.Implementations;

namespace FileCompositions.Extensions.Host.Schema.Register.Builder.Factory.Implementations;

internal class HostResourceSchemaRegisterBuilderFactory : IHostResourceSchemaRegisterBuilderFactory
{
