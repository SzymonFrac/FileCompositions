using FileCompositions.Core.File.Interface.Specialized.Json.ReadResult.Implementations;
using System.Diagnostics;

namespace FileCompositions.Core.File.Interface.Specialized.Json.ReadResult;
