...
public static partial class DbDefinitionBuilderFactoryExt
{
    ...
    {
        public DbDefinitionBuilder<StrictDefinition, RequiredDefinition, TDbContext> Db<TDbContext>(Action<IDbOptions<TDbContext>> config)
    ...
    {
        public DbDefinitionBuilder<StrictDefinition, OptionalDefinition, TDbContext> Db<TDbContext>(Action<IDbOptions<TDbContext>> config)
            where TDbContext : DbContext
        {
            var db = new DbOptions<TDbContext>();
            config(db);
