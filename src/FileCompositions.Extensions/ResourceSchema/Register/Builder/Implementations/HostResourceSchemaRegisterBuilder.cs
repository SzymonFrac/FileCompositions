...
using FileCompositions.Hosting.ResourceSchema.Register.Factory.Implementations;
...
internal sealed class HostResourceSchemaRegisterBuilder<TOwnership, TNecessity> : IHostResourceSchemaRegisterBuilder<TOwnership, TNecessity>
    where TOwnership : DefinitionOwnership
    where TNecessity : DefinitionNecessity
{
